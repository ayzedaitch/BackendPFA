...
public class Circuit {
    ...
    // When you specify columnDefinition = "TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP", you're telling JPA/Hibernate to handle the creation of this value on the database side.
